                ...
                <div className="post-creator-card">
                    <div className="creator-main">
                        {user?.profile_picture ? (
                            <img src={`${(import.meta.env.VITE_API_URL || 'http://127.0.0.1:8001').replace('/api/v1', '')}${user.profile_picture}`} alt="me" className="creator-avatar" />
                        ) : (
                ...
                <div className="author-luxe" onClick={() => onNavigate(`/profile/${post.author.id}`)}>
                    <div className="avatar-luxe-wrap">
                        {post.author.profile_picture ? (
                            <img src={`${(import.meta.env.VITE_API_URL || 'http://127.0.0.1:8001').replace('/api/v1', '')}${post.author.profile_picture}`} alt="avatar" />
                        ) : (
            ...
            <div className="post-body-luxe">
                ...
                {post.image_url && (
                    <div className="media-container-p">
                        <img src={`${(import.meta.env.VITE_API_URL || 'http://127.0.0.1:8001').replace('/api/v1', '')}${post.image_url}`} alt="post" />
                    </div>
                )}
